        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddSwaggerGen(c =>
            {
                ...
                c.SwaggerDoc("v1", new Info
                {
                    ...
                    Contact = new Contact
                    {
                        Name = "David Rodriguez (@davidjrh) for the Global Azure Bootcamp 2019 Science Lab running Sebastian Hidalgo's exoplanet search algorithm at the Instituo de Astrofisica de Canarias",
                        Email = "",
